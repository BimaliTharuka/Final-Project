...
Route::middleware(['auth', 'role:Admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/medical_submission', function () {
        return view('Admin.medical_submission');
    })->name('medical_submission');
    ...
    Route::prefix('medical-submissions')->group(function () {
        Route::get('/', [MedicalSubmissionController::class, 'index'])->name('admin.medical_submissions.index');
        Route::get('{id}', [MedicalSubmissionController::class, 'view'])->name('admin.medical_submissions.view');
        Route::get('download/{id}', [MedicalSubmissionController::class, 'download'])->name('admin.medical_submissions.download');
        Route::post('status/{id}', [MedicalSubmissionController::class, 'changeStatus'])->name('admin.medical_submissions.change_status');
    });
});
...
Route::prefix('student')->middleware(['auth', 'role:Student'])->group(function () {
    ...
    // Medical submissions
    Route::get('/medical_submission', [MedicalSubmissionController::class, 'showForm'])->name('student.medical_submission');
    Route::post('/medical_submission', [MedicalSubmissionController::class, 'submit'])->name('student.medical_submission.submit');
});
