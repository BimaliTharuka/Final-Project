                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{route('user_update', $users->id)}}"  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" value= "{{ $users->email }}"  class="form-control" id="exampleInputEmail3" name ="email" placeholder="Email">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <img src= "{{ Storage::url($users->user_image) }}" width="150px" >
                      </div>
