          ...
          <div class="col-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Create New batches</h4>
                    <p class="card-description"> Batch create form </p>
                    <form class="forms-sample" action ="{{route('batches.update', $batch->id)}}" method="post" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
