            ...
            <div class="col-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{route('exams.update', $exam->id)}}" method="post" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                      <div class="form-group">
                        <label for="exampleInputName1">Exam Name</label>
                        <input type="text" value= "{{ $exam->exam_name }}" class="form-control" id="exampleInputName1" name ="exam_name" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Date</label>
                        <input type="date" value= "{{ $exam->exam_date }}" class="form-control" id="exampleInputEmail3" name ="exam_date" placeholder="Date">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Course</label>
                        <input type="text" value= "{{ $exam->course }}" class="form-control" id="exampleInputName1" name ="course" placeholder="Name">
                      </div>

                      <!-- <button type="submit" class="btn btn-primary me-2">Submit</button> -->
                      <a href ="{{ route('exams.index', $exam->id) }}"><button type="submit" class="btn btn-primary btn-rounded btn-fw">Update</button></a>
