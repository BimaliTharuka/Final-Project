          ...
          <div class="col-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Edit New Batches</h4>
                    <p class="card-description"> Batch edit form </p>
                    <form class="forms-sample">
                      @csrf
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Batch Name</label>
                        <input type="text" class="form-control" value= "{{ $batch->name }}" id="exampleInputName1" name ="name" placeholder="Name" readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Description</label>
                        <input type="text" class="form-control" value= "{{ $batch->course_id }}" id="exampleInputEmail3" name ="description" placeholder="Course id" readonly>
                      </div>
                      <!-- <div class="form-group">
