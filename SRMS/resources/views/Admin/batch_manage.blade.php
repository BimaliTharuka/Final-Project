    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <a href ="{{ route('batches.create') }}" ><button type="button" class="btn btn-primary btn-rounded btn-fw">Create</button></a>
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Batches</h4>
                      <p class="card-description"> Add new batches here
                      </p>
                    <div class="table-responsive">
                      <table class="table table-hover">
                        ...
                        @foreach($batches as $batch)
                          <tr>
                            <td>{{ $batch->name }}</td>
                            <td>{{ $batch->course->description }}</td>
                            <td> <a href ="{{ route('batches.edit', $batch->id) }}" ><button type="button" class="btn btn-primary btn-rounded btn-fw">Edit</button></a>
                             <a href ="{{ route('batches.show', $batch->id) }}" ><button type="button" class="btn btn-primary btn-rounded btn-fw">View</button></a>
