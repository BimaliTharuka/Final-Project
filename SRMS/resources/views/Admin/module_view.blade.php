                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value= "{{ $module->name }}" id="exampleInputName1" name ="name" placeholder="Module Name" readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Description</label>
                        <input type="text" class="form-control" value= "{{ $module->description }}" id="exampleInputEmail3" name ="description" placeholder="Module Description" readonly>
                      </div>
