                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{route('courses.update', $course->id)}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value= "{{ $course->name }}" id="exampleInputName1" name ="name" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Description</label>
                        <input type="text" class="form-control" value= "{{ $course->description }}" id="exampleInputEmail3" name ="description" placeholder="Description">
                      </div>
                      <!-- <div class="form-group">
