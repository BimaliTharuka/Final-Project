          ...
          <div class="card-body">
            ...
            @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name= 'student_name' id="fullName" placeholder="Enter Name" required>
              </div>
              <!-- Name with Initials -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="tel" class="form-control" name= 'contactno' id="contactNumber" placeholder="Enter Contact Number" required>
              </div>
              <!-- Attempt -->
              <div class="form-group">
