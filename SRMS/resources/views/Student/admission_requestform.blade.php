      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" action ="{{route('admission-requests.store')}}" method="post" enctype="multipart/form-data">
            @csrf
              <!-- Student ID -->
              <div class="form-group">
                <label for="studentID">Student ID</label>
                <input type="text" name= 'student_id' class="form-control" id="studentID" placeholder="Enter Student ID" required>
              </div>
              <!-- Exam ID -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name= 'student_name' id="fullName" placeholder="Enter Name" >
              </div>
              <!-- Name with Initials -->
              <!-- <div class="form-group">
                <label for="NamewithInitials">Name with Initials</label>
                <input type="text" class="form-control" name= 'name' id="NamewithInitials" placeholder="Name with Initials" required>
              </div> -->
              <!-- Contact Number -->
              <div class="form-group">
                <label for="contactNumber">Contact Number</label>
                <input type="tel" class="form-control" name= 'contactno' id="contactNumber" placeholder="Enter Contact Number" >
              </div>
              <!-- Attempt -->
              <div class="form-group">
              ...
              <div class="form-check form-check-flat form-check-primary">
                <label class="form-check-label">
                  <input type="checkbox" class="form-check-input"> I hereby declare that the above information is true to the best of my knowledge and belies.
                </label>
              </div>
